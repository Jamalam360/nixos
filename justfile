...
deploy-lyra:
	git add . && nix-shell -p '(nixos{}).nixos-rebuild' --command 'nixos-rebuild switch --accept-flake-config --fast --flake .#lyra --use-remote-sudo --target-host "james@176.9.22.221"'

deploy-lyra-remote-build:
